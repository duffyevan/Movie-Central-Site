...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../SWDstyle.css">
...
<body>
    <ul class="pager left" style="padding-left: 50px">
        <li><a href="../../">&#x2190 Back to Movie Central</a></li>
    </ul>    
    <div class="container">
      <center><img style="width:80%" src="../../resources/sw.png"></center>
      <center><h1>Original Despecialized Star Wars Series</h1></center>
      <p style="text-align:center"><br><br></p>
      <h2>
          <?php 
          $dir = "/var/www/html/video/Star Wars Despecialized/";
          ...
          foreach ($files as $file){
            if ($file != "index.php" && $file != "." && $file != ".." && $file != ".htaccess" && $file != "style.css")
                echo "<center><div class='well' style='width: 60%'><center><a class='grey' href='" . $file . "'>" . str_replace(".mp4", "", str_replace(".mkv", "", str_replace(".avi", "", $file))) . "</a></center></div></center>";
        }
        ?>
    </h2>
</div>
